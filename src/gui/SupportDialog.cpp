...
void SupportDialog::buildUI()
{
    ...
    connect(sendBtn, &QPushButton::clicked, this, [this]() {
        ...
        static const QString kPromptTemplate =
            ...
            "- OS: %3\n"
            "- Radio: %4\n\n"
            "Before writing the bug report, please review the AetherSDR source code at\n"
            "https://github.com/ten9876/AetherSDR to understand the architecture.\n"
            "Read the CLAUDE.md file for project context, architecture overview, and\n"
            "known issues.\n\n"
